...
var url = "/assets/folder-icon.svg";
// var img = require("../../a")
export default {
	name: "Portfolio",
	components: {
			...
			<div id="side-bar">
				...
				<div id="sidebar-div">
					<div class="w-100 sidebar-child">
						...
						<!-- <div v-bind:style="{ 'background': 'url(' + require(folderIcon) + ')' }" class="iconlivin"></div>  -->
						<div v-bind:style="{ 'background': 'url(' + require('@/assets/folder-icon.svg') + ')' }" class="iconlivin"></div> 
						<p>All Projects</p>
					</div>
				</div>
			</div>
