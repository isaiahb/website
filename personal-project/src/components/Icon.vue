...
<template>
	<div id="icon" :class="classObject">
		<div id="icon-bg" class="mx-auto">
			...
			<!-- <div id="icon-image" class="mx-auto" v-bind:style="{ 'background-image': 'url(' + require('@/' + image) + ')'  }"></div> -->
			<!-- <div id="icon-image" class="mx-auto" v-bind:style="{ 'background-image': 'url('+require('@/'+image)+')'  }"></div> -->
			<div id="icon-image" class="mx-auto" v-bind:style="{ 'background-image': 'url('+require('@/assets/' + icon + '.svg')+')'  }"></div>
		</div>
